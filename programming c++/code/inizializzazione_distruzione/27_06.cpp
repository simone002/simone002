...
int main ()
  {
    ...
    Complex A [4]; // Il costruttore di default � necessario
		   // Viene eseguito a partire dall'indice 0
		   // Non inizializzato se non c'� alcun costruttore

    cout << "\n\nArray B :\n";

    Complex B [6] = { 2.3, //conversione 2.3 --> Complex(2.3) 
		      Complex(1.1), //costruttore 
		      Complex(), //costruttore senza parametri 
		      Complex(2.5,3.2) // costruttore con 2 paranmetri 
		    };
